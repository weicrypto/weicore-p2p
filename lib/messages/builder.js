...
function builder(options) {
  ...
  if (!options.network) {
    options.network = weicore.Networks.defaultNetwork;
  }

  options.Block = options.Block || weicore.Block;
  options.BlockHeader = options.BlockHeader || weicore.BlockHeader;
  options.Transaction = options.Transaction || weicore.Transaction;
  options.MerkleBlock = options.MerkleBlock || weicore.MerkleBlock;
  options.MnListDiff = options.MnListDiff || weicore.MnListDiff;
